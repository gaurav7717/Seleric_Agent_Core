...
HAND_MAP: dict[str, tuple[str | None, list[str]]] = {
    ...
    "amazon_cancelled_orders": ("amazonCancelledOrders", ["Commerce.CancelledOrder"]),
    "amazon_returned_orders": ("amazonReturnedOrders", ["Commerce.ReturnedOrder"]),
    "amazon_returns_cancels": ("amazonReturnsCancels", ["Commerce.returnsCancels"]),
    ...
    "amazon_return_revenue": ("amazonReturnRevenue", ["Commerce.ReturnCancelRevenue"]),
